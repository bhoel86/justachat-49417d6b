...
import { Send, AlertCircle, Zap, Smile, MoreHorizontal, Palette, Sparkles, ImagePlus, X, Loader2 } from "lucide-react";
...
const ChatInput = ({ onSend, isMuted = false, canControlRadio = false, onlineUsers = [], radioListenerCount = 0 }: ChatInputProps) => {
  ...
  return (
    <form onSubmit={handleSubmit} className="flex flex-col gap-2 p-4 bg-card border-t border-border">
      <RadioPlayerBar canControlRadio={canControlRadio} radioListenerCount={radioListenerCount} />
