...
export const MUSIC_LIBRARY: Genre[] = [
  ...
  },
  {
    ...
    icon: '🔫',
    songs: [
      { title: 'Dior', artist: 'Pop Smoke', videoId: 'LRxJuKEy9mk', genre: 'Drill' },
      { title: 'For the Night', artist: 'Pop Smoke ft. Lil Baby', videoId: '8-DLvLT5nME', genre: 'Drill' },
      { title: 'What You Know Bout Love', artist: 'Pop Smoke', videoId: 'OUldvjNVAL8', genre: 'Drill' },
      { title: 'Shake The Room', artist: 'Pop Smoke', videoId: '0xZ20DY5D8', genre: 'Drill' },
      ...
      { title: 'Meet the Woo', artist: 'Pop Smoke', videoId: 'S4N19g3x_lo', genre: 'Drill' },
      { title: 'Invincible', artist: 'Pop Smoke', videoId: 'FdZPJcMVXHo', genre: 'Drill' },
    ]
  },
  {
    name: 'Rock',
