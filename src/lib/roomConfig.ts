...
export const MODERATORS: Record<string, ModeratorInfo> = {
  ...
  'politics': { name: 'Debate', displayName: 'The Great Debater', avatar: '⚖️' },
...
export const WELCOME_MESSAGES: Record<string, string> = {
  ...
  'politics': "I'm Debate, The Great Debater! Every issue has multiple sides - I'll argue them ALL. Let's go! ⚖️",
