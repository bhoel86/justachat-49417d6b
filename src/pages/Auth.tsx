...
const Auth = () => {
  ...
  return (
    <div className="min-h-screen bg-background flex flex-col items-center justify-center p-4 sm:p-6 relative">
      ...
      <div className={`relative z-10 w-full max-w-md animate-slide-up ${isRetro ? 'mt-28 sm:mt-36' : '-mt-[112px]'}`}>
            ...
            <div className="mt-4">
              ...
              >
                <svg className="w-5 h-5" viewBox="0 0 24 24">
                  <path
                    fill={isRetro ? "#00FFFF" : isMatrix ? "hsl(120 100% 50%)" : "#4285F4"}
                    d="M22.56 12.25c0-.78-.07-1.53-.2-2.25H12v4.26h5.92c-.26 1.37-1.04 2.53-2.21 3.31v2.77h3.57c2.08-1.92 3.28-4.74 3.28-8.09z"
                  />
                  <path
                    fill={isRetro ? "#39FF14" : isMatrix ? "hsl(120 100% 45%)" : "#34A853"}
                    d="M12 23c2.97 0 5.46-.98 7.28-2.66l-3.57-2.77c-.98.66-2.23 1.06-3.71 1.06-2.86 0-5.29-1.93-6.16-4.53H2.18v2.84C3.99 20.53 7.7 23 12 23z"
                  />
                  <path
                    fill={isRetro ? "#FFFF00" : isMatrix ? "hsl(120 100% 40%)" : "#FBBC05"}
                    d="M5.84 14.09c-.22-.66-.35-1.36-.35-2.09s.13-1.43.35-2.09V7.07H2.18C1.43 8.55 1 10.22 1 12s.43 3.45 1.18 4.93l2.85-2.22.81-.62z"
                  />
                  <path
                    fill={isRetro ? "#FF00FF" : isMatrix ? "hsl(120 100% 35%)" : "#EA4335"}
                    d="M12 5.38c1.62 0 3.06.56 4.21 1.64l3.15-3.15C17.45 2.09 14.97 1 12 1 7.7 1 3.99 3.47 2.18 7.07l3.66 2.84c.87-2.6 3.3-4.53 6.16-4.53z"
                  />
                </svg>
                {isRetro ? '> GOOGLE' : isMatrix ? 'GOOGLE ACCESS' : 'Continue with Google'}
              </Button>
          ...
          <div className="flex flex-col items-center gap-1">
            ...
            <div className="flex items-center gap-1.5">
              <a 
                ...
                className={`w-6 h-6 sm:w-7 sm:h-7 flex items-center justify-center transition-colors group ${
                ...
                title="Facebook"
              >
                <svg className="w-3 h-3 sm:w-3.5 sm:h-3.5" viewBox="0 0 24 24" fill={isRetro ? "#00FFFF" : "currentColor"} style={isRetro ? { filter: 'drop-shadow(0 0 4px #00FFFF)' } : undefined}>
              ...
              <a 
                ...
                title="Instagram"
              >
                <svg className="w-3 h-3 sm:w-3.5 sm:h-3.5" viewBox="0 0 24 24" fill={isRetro ? "#FF00FF" : "currentColor"} style={isRetro ? { filter: 'drop-shadow(0 0 4px #FF00FF)' } : undefined}>
              ...
              <a 
                ...
                title="TikTok"
              >
                <svg className="w-3 h-3 sm:w-3.5 sm:h-3.5" viewBox="0 0 24 24" fill={isRetro ? "#FFFF00" : "currentColor"} style={isRetro ? { filter: 'drop-shadow(0 0 4px #FFFF00)' } : undefined}>
              ...
              <a 
                ...
                title="X (Twitter)"
              >
                <svg className="w-3 h-3 sm:w-3.5 sm:h-3.5" viewBox="0 0 24 24" fill={isRetro ? "#39FF14" : "currentColor"} style={isRetro ? { filter: 'drop-shadow(0 0 4px #39FF14)' } : undefined}>
            ...
            <div className="text-center">
              <p className={`text-[10px] ${isRetro ? 'font-mono uppercase tracking-wider' : 'text-muted-foreground'}`}
                 style={isRetro ? { color: '#00FFFF', textShadow: '0 0 8px rgba(34,211,238,0.6)' } : undefined}>
                {isRetro ? '> ' : ''}© {new Date().getFullYear()} Justachat™
              </p>
              <div className="flex items-center justify-center gap-1.5">
                <a 
                  href="https://justachat.net" 
                  className={`text-[10px] transition-colors ${isRetro ? 'font-mono uppercase hover:text-cyan-300' : 'text-muted-foreground hover:text-primary'}`}
                  style={isRetro ? { color: '#FF00FF', textShadow: '0 0 6px rgba(255,0,255,0.5)' } : undefined}
                >
                  {isRetro ? '[ JUSTACHAT.NET ]' : 'justachat.net'}
                </a>
                <span className={`text-[10px] ${isRetro ? '' : 'text-muted-foreground/50'}`} style={isRetro ? { color: '#FFFF00' } : undefined}>
                  {isRetro ? '|' : '•'}
                </span>
                <Link 
                  to="/legal" 
                  className={`text-[10px] transition-colors ${isRetro ? 'font-mono uppercase hover:text-green-300' : 'text-muted-foreground hover:text-primary'}`}
