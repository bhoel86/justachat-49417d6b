            ...
            <div className="flex flex-col items-center gap-2">
              ...
              <div className="flex items-center gap-2">
                <a 
                  ...
                  className={`w-7 h-7 sm:w-8 sm:h-8 flex items-center justify-center transition-colors group ${
                  ...
                  title="Facebook"
                >
                  <svg className="w-3.5 h-3.5 sm:w-4 sm:h-4" viewBox="0 0 24 24" fill={isRetro ? "#00FFFF" : "currentColor"} style={isRetro ? { filter: 'drop-shadow(0 0 4px #00FFFF)' } : undefined}>
                ...
                <a 
                  ...
                  title="Instagram"
                >
                  <svg className="w-3.5 h-3.5 sm:w-4 sm:h-4" viewBox="0 0 24 24" fill={isRetro ? "#FF00FF" : "currentColor"} style={isRetro ? { filter: 'drop-shadow(0 0 4px #FF00FF)' } : undefined}>
                ...
                <a 
                  ...
                  title="TikTok"
                >
                  <svg className="w-3.5 h-3.5 sm:w-4 sm:h-4" viewBox="0 0 24 24" fill={isRetro ? "#FFFF00" : "currentColor"} style={isRetro ? { filter: 'drop-shadow(0 0 4px #FFFF00)' } : undefined}>
                ...
                <a 
                  ...
                  title="X (Twitter)"
                >
                  <svg className="w-3.5 h-3.5 sm:w-4 sm:h-4" viewBox="0 0 24 24" fill={isRetro ? "#39FF14" : "currentColor"} style={isRetro ? { filter: 'drop-shadow(0 0 4px #39FF14)' } : undefined}>
