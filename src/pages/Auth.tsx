          ...
          <div className="flex flex-col items-center gap-1">
            ...
            <div className="flex items-center gap-1.5">
              <a 
                ...
                title="Facebook"
              >
                <svg className="w-3 h-3 sm:w-3.5 sm:h-3.5" viewBox="0 0 24 24" fill={isRetro ? "#00FFFF" : "currentColor"}>
              ...
              <a 
                ...
                title="Instagram"
              >
                <svg className="w-3 h-3 sm:w-3.5 sm:h-3.5" viewBox="0 0 24 24" fill={isRetro ? "#FF00FF" : "currentColor"}>
              ...
              <a 
                ...
                title="TikTok"
              >
                <svg className="w-3 h-3 sm:w-3.5 sm:h-3.5" viewBox="0 0 24 24" fill={isRetro ? "#FFFF00" : "currentColor"}>
              ...
              <a 
                ...
                title="X (Twitter)"
              >
                <svg className="w-3 h-3 sm:w-3.5 sm:h-3.5" viewBox="0 0 24 24" fill={isRetro ? "#39FF14" : "currentColor"}>
            ...
            <div className="text-center">
              <p className={`text-[10px] ${isRetro ? 'font-mono uppercase tracking-wider text-cyan-400' : 'text-muted-foreground'}`}>
