            ...
            {isRetro ? (
              ...
              <div className="flex justify-center">
                <img 
                  ...
                  className="w-full max-w-md h-auto object-contain rounded-xl border-4 border-primary"
                />
              </div>
            )}
          </div>
              ...
              {isRetro ? (
                ...
                <div className="flex justify-center">
                  <img 
                    src={welcomeBanner} 
                    alt="Welcome to Justachat" 
                    className="w-full max-w-xl h-auto object-contain cursor-pointer hover:opacity-95 transition-opacity rounded-xl border-4 border-primary"
                    onClick={() => {
                      const generalChannel = channels.find(c => c.name === 'general');
                      if (generalChannel) handleJoinRoom(generalChannel);
                    }}
