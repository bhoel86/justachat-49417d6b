                  ...
                  <div className="flex items-center">
                    ...
                    <div className="flex flex-col items-center">
                      <div className="flex items-center gap-2 sm:gap-3">
                        ...
                        <a 
                          ...
                          className={`w-8 h-8 sm:w-9 sm:h-9 flex items-center justify-center transition-all group ${
                            isRetro 
                              ? 'rounded-none border-2 border-cyan-400 bg-black/60 hover:bg-cyan-400/30' 
                              : 'rounded-lg bg-secondary hover:bg-primary/20'
                          }`}
                          style={isRetro ? { boxShadow: '0 0 10px rgba(34,211,238,0.4)' } : undefined}
                          title="Facebook"
                        >
                          <svg className={`w-4 h-4 sm:w-5 sm:h-5 transition-colors ${
                            isRetro ? 'text-cyan-400 group-hover:text-cyan-300' : 'text-muted-foreground group-hover:text-primary'
                        ...
                        <a 
                          ...
                          className={`w-8 h-8 sm:w-9 sm:h-9 flex items-center justify-center transition-all group ${
                            isRetro 
                              ? 'rounded-none border-2 bg-black/60 hover:bg-magenta-500/30' 
                              : 'rounded-lg bg-secondary hover:bg-primary/20'
                          }`}
                          style={isRetro ? { borderColor: '#FF00FF', boxShadow: '0 0 10px rgba(255,0,255,0.4)' } : undefined}
                          title="Instagram"
                        >
                          <svg className={`w-4 h-4 sm:w-5 sm:h-5 transition-colors ${
                            isRetro ? '' : 'text-muted-foreground group-hover:text-primary'
                          }`} style={isRetro ? { color: '#FF00FF' } : undefined} viewBox="0 0 24 24" fill="currentColor">
                        ...
                        <a 
                          ...
                          className={`w-8 h-8 sm:w-9 sm:h-9 flex items-center justify-center transition-all group ${
                            isRetro 
                              ? 'rounded-none border-2 border-yellow-400 bg-black/60 hover:bg-yellow-400/30' 
                              : 'rounded-lg bg-secondary hover:bg-primary/20'
                          }`}
                          style={isRetro ? { boxShadow: '0 0 10px rgba(250,204,21,0.4)' } : undefined}
                          title="TikTok"
                        >
                          <svg className={`w-4 h-4 sm:w-5 sm:h-5 transition-colors ${
                            isRetro ? 'text-yellow-400 group-hover:text-yellow-300' : 'text-muted-foreground group-hover:text-primary'
                          }`} viewBox="0 0 24 24" fill="currentColor">
                        ...
                        <a 
                          ...
                          className={`w-8 h-8 sm:w-9 sm:h-9 flex items-center justify-center transition-all group ${
                            isRetro 
                              ? 'rounded-none border-2 bg-black/60 hover:bg-green-400/30' 
                              : 'rounded-lg bg-secondary hover:bg-primary/20'
                          }`}
                          style={isRetro ? { borderColor: '#39FF14', boxShadow: '0 0 10px rgba(57,255,20,0.4)' } : undefined}
                          title="X (Twitter)"
                        >
                          <svg className={`w-4 h-4 sm:w-5 sm:h-5 transition-colors ${
                            isRetro ? '' : 'text-muted-foreground group-hover:text-primary'
                          }`} style={isRetro ? { color: '#39FF14' } : undefined} viewBox="0 0 24 24" fill="currentColor">
                      ...
                      <div className="text-center mt-2">
                        <p className={`text-xs ${
                          isRetro ? 'font-mono text-cyan-400/70' : 'text-muted-foreground'
                        }`} style={isRetro ? { textShadow: '0 0 5px rgba(34,211,238,0.4)' } : undefined}>
                          {isRetro ? `[ © ${new Date().getFullYear()} JUSTACHAT™ ]` : `© ${new Date().getFullYear()} Justachat™ All rights reserved.`}
                        </p>
                        <div className="flex items-center justify-center gap-2">
                          <a 
                            ...
                            className={`text-xs transition-colors ${
                              isRetro 
                                ? 'font-mono hover:text-cyan-300' 
                                : 'text-muted-foreground hover:text-primary'
                            }`}
                            style={isRetro ? { color: '#FF00FF', textShadow: '0 0 5px rgba(255,0,255,0.5)' } : undefined}
                          >
                            {isRetro ? '> JUSTACHAT.NET' : 'justachat.net'}
                          </a>
                          <span className={`text-xs ${isRetro ? 'text-cyan-400/30' : 'text-muted-foreground/50'}`}>•</span>
                          <Link 
                            to="/legal" 
                            className={`text-xs transition-colors ${
                              isRetro 
                                ? 'font-mono hover:text-green-300' 
                                : 'text-muted-foreground hover:text-primary'
                            }`}
                            style={isRetro ? { color: '#39FF14', textShadow: '0 0 5px rgba(57,255,20,0.5)' } : undefined}
                          >
                            {isRetro ? '> LEGAL' : 'Legal'}
                          </Link>
                        </div>
