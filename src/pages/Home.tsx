      ...
      {isMobile ? (
        ...
        <>
          ...
          <main className="container mx-auto px-3 sm:px-4 py-2 flex-1 flex flex-col overflow-hidden min-h-0">
            ...
            <footer className={`border-t mt-2 pt-2 flex-shrink-0 ${
              ...
              <div className="flex items-center">
                ...
                <div className="flex items-center gap-3">
                  <div className={`h-7 w-7 sm:h-8 sm:w-8 flex items-center justify-center shadow-lg ${
                    isRetro 
                      ? 'rounded-none border-2 border-cyan-400 bg-black/80' 
                      : 'rounded-lg jac-gradient-bg'
                ...
                <div className="flex items-end gap-2 sm:gap-4 -ml-16">
                  ...
                  <div className="flex flex-col items-center">
                    <div className="flex items-center gap-1.5 sm:gap-2">
                      ...
                      <a 
                        ...
                        className={`w-6 h-6 sm:w-7 sm:h-7 flex items-center justify-center transition-colors group ${
                          isRetro ? 'rounded-none border bg-black/80' : 'rounded-md bg-secondary hover:bg-primary/20'
                        }`}
                        style={isRetro ? { 
                          borderColor: '#00FFFF',
                        ...
                        title="Facebook"
                      >
                        <svg className="w-3 h-3 sm:w-4 sm:h-4" viewBox="0 0 24 24" fill={isRetro ? "#00FFFF" : "currentColor"} style={isRetro ? { filter: 'drop-shadow(0 0 4px #00FFFF)' } : undefined}>
                      ...
                      <a 
                        ...
                        title="Instagram"
                      >
                        <svg className="w-3 h-3 sm:w-4 sm:h-4" viewBox="0 0 24 24" fill={isRetro ? "#FF00FF" : "currentColor"} style={isRetro ? { filter: 'drop-shadow(0 0 4px #FF00FF)' } : undefined}>
                      ...
                      <a 
                        ...
                        title="TikTok"
                      >
                        <svg className="w-3 h-3 sm:w-4 sm:h-4" viewBox="0 0 24 24" fill={isRetro ? "#FFFF00" : "currentColor"} style={isRetro ? { filter: 'drop-shadow(0 0 4px #FFFF00)' } : undefined}>
                      ...
                      <a 
                        ...
                        title="X (Twitter)"
                      >
                        <svg className="w-3 h-3 sm:w-4 sm:h-4" viewBox="0 0 24 24" fill={isRetro ? "#39FF14" : "currentColor"} style={isRetro ? { filter: 'drop-shadow(0 0 4px #39FF14)' } : undefined}>
                    ...
                    <div className="text-center mt-1">
                      <p className={`text-[10px] sm:text-xs ${isRetro ? 'font-mono uppercase tracking-wider' : 'text-muted-foreground'}`}
