    ...
    <div className="min-h-screen bg-background text-foreground relative">
      ...
      {isMobile ? (
        ...
        <>
          ...
          <main className="container mx-auto px-3 sm:px-4 py-2 flex-1 flex flex-col overflow-hidden min-h-0">
              ...
              <div className="lg:w-52 xl:w-56 flex-shrink-0 h-full">
                <div className={`p-2 sm:p-3 h-full overflow-hidden flex flex-col ${
                  ...
                  {loadingChannels ? (
                    ...
                    <>
                      <div className="grid grid-cols-3 sm:grid-cols-4 lg:grid-cols-2 gap-1.5 lg:flex-1 lg:overflow-y-auto lg:pr-1 scrollbar-thin">
            ...
            <footer className={`border-t mt-2 pt-2 flex-shrink-0 relative ${
              isRetro ? 'memphis-footer' : 'border-border'
            }`}>
              {/* Memphis confetti decorations */}
              {isRetro && (
                <>
                  <div className="absolute top-1 left-2 w-3 h-3 bg-[#FF00FF] rotate-45" />
                  <div className="absolute top-2 left-8 w-2 h-2 rounded-full bg-[#00FFFF]" />
                  <div className="absolute top-1 right-4 w-4 h-4 bg-[#FFD700]" style={{ clipPath: 'polygon(50% 0%, 100% 100%, 0% 100%)' }} />
                  <div className="absolute top-3 right-12 w-2 h-2 rounded-full bg-[#39FF14]" />
                </>
              )}
              ...
              <div className="flex items-center">
                ...
                <div className="flex items-center gap-3">
                  <div className={`h-7 w-7 sm:h-8 sm:w-8 flex items-center justify-center ${
                    isRetro 
                      ...
                      : 'shadow-lg rounded-lg jac-gradient-bg'
                  }`} style={isRetro ? { boxShadow: '3px 3px 0 #000' } : undefined}>
                    <MessageSquare className={`w-3 h-3 sm:w-4 sm:h-4 ${isRetro ? 'text-cyan-400' : 'text-primary-foreground'}`} />
                  </div>
                  <div>
                    <h3 className={`text-sm sm:text-base font-bold ${
                      isRetro ? 'font-mono uppercase text-cyan-400' : 'jac-gradient-text'
                    }`}>
                      {isRetro ? 'JUSTACHAT' : 'Justachat'}<sup className="text-[6px]">™</sup>
                    </h3>
                    <p className={`text-xs ${
                ...
                <div className="flex items-end gap-2 sm:gap-4 -ml-16">
                  ...
                  {/* Center: Social + Copyright - this is the core */}
                  <div className="flex flex-col items-center">
                    <div className="flex items-center gap-1.5 sm:gap-2">
                      ...
                      <a 
                        ...
                        className={`w-6 h-6 sm:w-7 sm:h-7 flex items-center justify-center transition-all group ${
                          isRetro ? 'memphis-social-btn' : 'rounded-md bg-secondary hover:bg-primary/20'
                        }`}
                        style={isRetro ? { borderColor: '#00FFFF' } : undefined}
                        title="Facebook"
                      >
                        <svg className="w-3 h-3 sm:w-4 sm:h-4" viewBox="0 0 24 24" fill={isRetro ? "#00FFFF" : "currentColor"}>
                      ...
                      <a 
                        ...
                        title="Instagram"
                      >
                        <svg className="w-3 h-3 sm:w-4 sm:h-4" viewBox="0 0 24 24" fill={isRetro ? "#FF00FF" : "currentColor"}>
                      ...
                      <a 
                        ...
                        title="TikTok"
                      >
                        <svg className="w-3 h-3 sm:w-4 sm:h-4" viewBox="0 0 24 24" fill={isRetro ? "#FFD700" : "currentColor"}>
                      ...
                      <a 
                        ...
                        title="X (Twitter)"
                      >
                        <svg className="w-3 h-3 sm:w-4 sm:h-4" viewBox="0 0 24 24" fill={isRetro ? "#39FF14" : "currentColor"}>
                    ...
                    <div className="text-center mt-1">
                      <p className={`text-[10px] sm:text-xs ${isRetro ? 'font-mono uppercase tracking-wider text-cyan-400' : 'text-muted-foreground'}`}>
