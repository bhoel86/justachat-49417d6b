          ...
          <div className="lg:w-80 xl:w-96 flex-shrink-0">
            ...
            {loadingChannels ? (
              ...
              <>
                ...
                {/* Justachat Dating Section */}
                <div className="mt-6 lg:mt-8">
                  <div className="flex items-center justify-between gap-3 px-1 mb-2">
                    <div className="flex items-center gap-2">
                      <div className="h-7 w-7 rounded-xl jac-gradient-bg flex items-center justify-center">
                        <MessageSquare className="w-4 h-4 text-primary-foreground" />
                      </div>
                      <div>
                        <p className="text-sm font-bold">Justachat Dating</p>
                        <p className="text-xs text-muted-foreground">Swipe, match, chat</p>
                      </div>
                    </div>
                  </div>
                  <Link
