          ...
          <main className="container mx-auto px-3 sm:px-4 py-4 sm:py-8">
            ...
            <div className="flex flex-col lg:flex-row lg:items-stretch gap-4 sm:gap-6">
              ...
              <div className="flex-1 min-w-0 flex flex-col">
                ...
                <div className="bg-card rounded-xl sm:rounded-2xl border border-border flex-1 flex flex-col overflow-hidden max-h-[200px] lg:max-h-[300px]">
                  {/* Topic bar */}
              ...
              <div className="flex flex-col sm:flex-row items-center justify-between gap-4">
                ...
                <div className="flex items-center gap-3">
                  <a 
                    ...
                    className="w-9 h-9 rounded-lg bg-secondary hover:bg-primary/20 flex items-center justify-center transition-colors group"
                    title="Facebook"
                  >
